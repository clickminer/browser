...
/**
 * <p>RequestVertexLabelProvider class.</p>
 *
 * @author Chris Neasbitt
 * @version $Id: RequestVertexLabelProvider.java 843 2013-10-03 16:26:11Z cjneasbitt $Id
 */
public class RequestVertexLabelProvider implements
		VertexNameProvider<AbstractFlowVertex> {

	/** {@inheritDoc} */
	@Override
	public String getVertexName(AbstractFlowVertex arg0) {
		return arg0.getId() + " " + arg0.getUrl();
	}
